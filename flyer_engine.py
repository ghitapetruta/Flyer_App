...
.grid > .card:nth-child(1) .card-bottom { min-height: 88px; }
...
.grid > .card:nth-child(3) .card-bottom { min-height: 56px; }
...
.grid > .card .card-bottom { padding: 18px 28px; min-height: 100px; }
...
.grid > .card .card-bottom { min-height: 80px; }
...
.grid > .card .card-bottom { min-height: 72px; }
...
.grid > .card .card-bottom { min-height: 76px; }
